...
class SingleChunkQa(Task[SingleChunkQaInput, SingleChunkQaOutput]):
    ...
    Args:
        ...
        explainability_enabled: whether you need to explainability feature or not; default False.
    ...
    def __init__(
        ...
        self._explainability_enabled = explainability_enabled
    ...
    def do_run(
        ...
        if self._explainability_enabled:
            raw_highlights = (
