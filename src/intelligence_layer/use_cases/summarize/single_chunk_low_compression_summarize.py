...
class SingleChunkLowCompressionSummarize(SingleChunkFewShotSummarize):
    """Condenses a text section into a longer summary.
    ...
    Example:
        ...
        >>> task = LowCompressionSummarize(client)
        ...
        >>> logger = InMemoryLogger(name="LowCompressionSummarize")
        >>> output = task.run(input, logger)
        >>> print(output.summary)
        Tina does not like pizza. Mike likes pizza. Pete believes that pizza is the best thing.
    """
