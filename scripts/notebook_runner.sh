...
find src/documentation -name "*.ipynb" ! -name "performance_tips.ipynb" ! -name "document_index.ipynb" | xargs --max-args 1 --max-procs 6 poetry run jupyter nbconvert --to notebook --execute
find src/documentation -name "*.nbconvert.ipynb" -type f -delete
