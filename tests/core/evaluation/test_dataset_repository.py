...
def test_in_memory_dataset_repository_can_store_dataset(
    ...
    id = in_memory_dataset_repository.create_dataset(
        name="dummy dataset",
    ...
    dataset = in_memory_dataset_repository.dataset(
        id, input_type=DummyStringInput, expected_output_type=DummyStringOutput
    )
    assert dataset
...
def test_in_memory_dataset_repository_can_delete_dataset(
    ...
    assert (
        in_memory_dataset_repository.dataset(id, DummyStringInput, DummyStringOutput)
        is None
    )
...
def test_in_memory_dataset_repository_can_list_datasets(
    ...
    id0 = in_memory_dataset_repository.create_dataset(
        name=dataset_name,
        examples=[(dummy_string_example.input, dummy_string_example.expected_output)],
    )
    id1 = in_memory_dataset_repository.create_dataset(
        name=dataset_name,
        examples=[(dummy_string_example.input, dummy_string_example.expected_output)],
    )
