...
def test_example_evaluation_returns_none_if_evaluation_id_or_example_id_does_not_exist(
    repository_fixture: str,
    request: FixtureRequest,
    ...
    assert stored_example_evaluations == [None, None, None]
